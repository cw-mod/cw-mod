...
<h4>Скрипт стоит, но ничего не происходит</h4>
<div>Иногда Tampermonkey молча не применяет скрипт. Это не баг мода: в Chrome/Edge (и браузерах на их движке) нужно отдельно разрешить выполнение userscript'ов.</div>

<ul>
<li>
<b>Chrome 138 и новее:</b> ПКМ по иконке Tampermonkey → «Управление расширением» → включить переключатель <b>«Разрешить пользовательские скрипты»</b> (Allow User Scripts).
</li>
<li>
<b>Если такого переключателя нет</b> (старый Chrome или другой браузер): открыть <code>chrome://extensions</code> (в Edge — <code>edge://extensions</code>) и включить <b>режим разработчика</b> справа сверху.
</li>
</ul>
<div>После этого перезагрузить страницу вара. Подробнее — в <a href="https://www.tampermonkey.net/faq.php?locale=ru&q=Q209" target="_blank">FAQ Tampermonkey</a>.</div>
<hr>
